    ...
    implements OperationFactory
{
    ...
    public IListMapReduceOperationFactory()
    {
    }

    public IListMapReduceOperationFactory( String name, Mapper<KeyIn, ValueIn, KeyOut, ValueOut> mapper,
    ...
    public Operation createOperation()
    {
        ...
        return new IListMapReduceOperation<KeyIn, ValueIn, KeyOut, ValueOut>( name, mapper, r );
    }
